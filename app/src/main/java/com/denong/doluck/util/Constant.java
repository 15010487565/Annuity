...
public class Constant {
    ...
    public final static String KEY_PRE_PHONE_SCRIP = "securityphone";
    public static final String HTTP_BASE_URL = "https://www.cmpassport.com/unisdk/rsapi/loginTokenValidate";//现网 https
