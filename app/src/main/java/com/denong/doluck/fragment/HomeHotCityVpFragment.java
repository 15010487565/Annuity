...
public class HomeHotCityVpFragment extends Fragment {
    private View view;
    private static final String KEY = "title";
    private TextView tvContent;
    static HomeRcHotCityAdapter.OnHomehotCityItemClickListener mlistener;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        view = inflater.inflate(R.layout.fragment_home_rc_hotcity,container,false);
        RecyclerView recyclerView = view.findViewById(R.id.iten_home_rc_top);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
        linearLayoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
        recyclerView.setLayoutManager(linearLayoutManager);
        HomeRcHotCityAdapter adapter = new HomeRcHotCityAdapter(getActivity());
     ...
     * fragment静态传值
     */
    public static HomeHotCityVpFragment newInstance(String str, HomeRcHotCityAdapter.OnHomehotCityItemClickListener listener){
        mlistener = listener;
        HomeHotCityVpFragment fragment = new HomeHotCityVpFragment();
