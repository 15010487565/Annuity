...
# in E:\AS\adt-bundle-windows-x86-20130917\sdk/tools/proguard/proguard-android.txt
...
-libraryjars ../mylibrary/libs/YYImSdk.jar
-libraryjars ../mylibrary/libs/BASE64Decoder.jar
# 移动一键登录
-dontwarn com.cmic.sso.sdk.**
-keep public class com.cmic.sso.sdk.*{*;}

-keep class com.denong.doluck.func.** { *; }
-keep class com.denong.doluck.model.** { *; }
-keep class com.denong.doluck.view.** { *; }

-keep class www.xcd.com.mylibrary.** { *; }